      ...
      <div className="relative container mx-auto px-6 z-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4 sm:mb-6 leading-tight px-4 text-white">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-200 leading-relaxed max-w-3xl mx-auto px-4">
          ...
          <div className="mb-12 sm:mb-16 px-4">
            <div className="flex items-center justify-center mb-6 sm:mb-8">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-serif font-bold text-center text-white">
          ...
          <div className="text-center px-4">
            <div className="bg-gradient-to-r from-primary/20 to-troiton-600/20 border border-primary/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12">
              <div className="flex flex-col sm:flex-row items-center justify-center mb-4 sm:mb-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-200 text-center">
              ...
              <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center sm:items-center">
                ...
                <div className="text-xs sm:text-sm text-gray-300 sm:ml-4">
