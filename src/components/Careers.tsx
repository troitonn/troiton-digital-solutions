            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[ 
                ...
                <div key={index} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/20 rounded-full flex items-center justify-center mb-3 sm:mb-4">
          ...
          <div className="text-center px-4">
            <div className="bg-gradient-to-r from-primary/20 to-troiton-600/20 border border-primary/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12">
              ...
              <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center sm:items-center">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 w-full sm:w-auto" onClick={() => window.location.href = 'mailto:vagas@troiton.com.br'}>
                  Enviar Currículo
