            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-troiton-800/50 rounded-lg overflow-hidden">
                ...
                <img 
                  ...
                  className="rounded-lg object-cover w-full max-w-lg opacity-70 hover:opacity-90 transition-opacity"
                  loading="lazy"
                />
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-black/40 border border-troiton-800/50 p-6 rounded-lg relative group hover:bg-troiton-900/20 transition-colors">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <div className="text-troiton-400 font-bold text-3xl">+100</div>
                </div>
              ...
              <div className="bg-black/40 border border-troiton-800/50 p-6 rounded-lg relative group hover:bg-troiton-900/20 transition-colors">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <div className="text-blue-400 font-bold text-3xl">+50</div>
                </div>
